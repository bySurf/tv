(function() {
      ...
      function isNavOverridePage() {
        ...
        for (var i = 0; i < NAV_OVERRIDE_PATHS.length; i++) {
          if (path === NAV_OVERRIDE_PATHS[i] || path.indexOf(NAV_OVERRIDE_PATHS[i]) !== -1) return true;
        }
        return false;
      }
      ...
      function injectNavAndScript() {
        ...
        var stickyNavHtml = '<header class="sticky-nav" id="fwStickyNav">' +
          '<div class="nav-container">' +
            '<div class="nav-left">' +
              '<a href="' + BASE + '/videos" class="nav-logo"><img src="https://imgproxy.fourthwall.com/jm8_1IXS11ENpRBQOnDGD2LR2AIemqwHG5r9xZUkgyM/w:125/sm:1/enc/yY0t3w5BLDeCHl1n/vWdqIn1TCv2Z1qcM/d2iCajrnyQXqwPuf/9HtKWT_F2KCXFsoi/endtDTvYu3-L1-hF/uRwbv30xzJ5nyAa7/jzjhtsKtsnCVKmCu/uGygFicxUwPmEBxn/bFGa2d79RIJdM5vL/rekNF6Rp9epMylaV/Cx2qsO-R1ciIXlhY/0TBjzvFMCLVwuvHO/HJy59VjSYCI_8hOM/PraprysdLKUs2bYf/kQEeGP72K0cOQ_Rt/2kvC99eSpI5P03Vm" alt="bySurf TV"></a>' +
              '<nav class="nav-menu nav-menu-left" id="navMenu"><a href="' + BASE + '/pages/report-bugs" class="nav-link">Report a bug</a></nav>' +
            '</div>' +
            '<div class="nav-right">' +
              '<a href="' + BASE + '/pages/notifications" class="nav-link nav-icon-link hidden" id="your-notifications" aria-label="Notifications"><img src="https://imgproxy.fourthwall.com/MlXZax4zdgvPZoJcr6ctjwsj_INI9YBR_L6eAJVBpgI/rt:fill/w:890/el:0/q:90/sm:1/enc/NWU5MzQ4M2JkYjAy/ZmNjZpaF50uHVjxH/CPVLu01Uqm-oEDS3/IcG_TymwWTKJYlm6/jq7JXsPXnRuLQANR/SBMs4DjfcLfkKHUp/J_ICbqOIp9k4yWog/RvF0CgGcII59iwLL/mKT2dd_vftx6y9JS/FopxSC-TOb6TBlwo/_uqS4asbIzY.webp" class="notifications-img" alt=""></a>' +
              '<a href="' + BASE + '/supporters/perks" class="nav-link nav-icon-link hidden" id="discord-perks" aria-label="Discord &amp; perks" target="_blank" rel="noopener"><svg class="discord-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/></svg></a>' +

(function() {
    ...
    function injectNavAndScript() {
      ...
      var searchSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85zM12 6.5a5.5 5.5 0 1 1-11 0a5.5 5.5 0 0 1 11 0"/></svg>';
      var mobileNavHtml = '<nav class="mobile-bottom-nav" id="mobileBottomNav">' +
        ...
        '<a href="' + BASE + '/videos" class="mobile-nav-search-slot" id="mobileNavSearchSlot" aria-label="Search"><span class="mobile-search-btn-in-nav">' + searchSvg + '</span></a>' +
